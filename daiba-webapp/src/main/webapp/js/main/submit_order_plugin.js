        ...
        var b = "ontouchstart" in document,
            ...
            i = a.Numbox = a.Class.extend({
                init: function(b, c) {
                    ...
                    d.holder = b, c = c || {}, c.step = parseFloat(c.step || 1.0), d.options = c, d.input = a.qsa(h, d.holder)[0], d.plus = a.qsa(f, d.holder)[0], d.minus = a.qsa(g, d.holder)[0], d.checkValue(), d.initEvent()
                },
                initEvent: function() {
                    var b = this;
                ...
                checkValue: function() {
                    ...
                    if(null == b || "" == b || isNaN(b)) a.input.value = a.options.min || 0, a.minus.disabled = null != a.options.min;
                        ...
                        var b = parseFloat(b);
                        null != a.options.max && !isNaN(a.options.max) && b >= parseFloat(a.options.max) ? (b = a.options.max, a.plus.disabled = !0) : a.plus.disabled = !1.0, null != a.options.min && !isNaN(a.options.min) && b <= parseFloat(a.options.min)? (b = a.options.min, a.minus.disabled = !0) : a.minus.disabled = !1, a.input.value = b
                    }
                },
